...
class Factory {
    ...
    // Class keyword
    // Class functions are called on the factory class however instance functions require an instance of the actual class (ie new Factory)
